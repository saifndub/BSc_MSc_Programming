...
//Function to insert a node at the front of a single linked 1ist.
void insert_front()
{
    int data_value;
...
//Function to insert a node at the end of a single 1inked 1ist.
void insert_end()
{
    int data_value;
...
//Function to display the contents of the 1inked 1ist.
void display()
{

    printf("\nContents of the  1inked list are:\n");
//printf the contents of the 1inked 1ist starting from header
    ptr = header;
    while (ptr->link != NULL)
    {
        ptr = ptr->link;
